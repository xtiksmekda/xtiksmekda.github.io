  ...
  <body data-bs-spy="scroll" data-bs-target="#navbar-example2">
    ...
    <section id="about">
      <div class="container">
        <div class="row text-center mb-3">
          <div class="col">
            <h2 style="color: white">About Software</h2>
          </div>
        </div>
        <div class="row justify-content-center fs-6 text-center">
          <div class="col-md-4">
            <p style="color: white">
              Software adalah salah satu bidang yang dimiliki X-TIK dimana kita belajar mengenai Bahasa Pemrograman, mulai dari HTML, CSS & JavaScript kita juga menggunakan Framework Bootstrap.
            </p>
          </div>
          <div class="col-md-4">
            <p style="color: white">Bentuk kegiatan bidang software ini lebih ke arah projek dan studi kasus agar semua anggota dapat memahami sekaligus mempelajari tentang Bahasa Pemrograman.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="projects">
      ...
      <div class="container">
            <div class="row text-center mb-3">
              <div class="col">
                <h2 style="color: white; margin-top: 70px;">Projects</h2>
              </div>
            </div>
            <div class="row gy-4">
            <div class="col-12 col-sm-6 col-md-4">
                <a class="d-block" href="bidang/software/azfa/index.html" target="_blank">
                  <img width="1920" height="1280" src="assets/images/Linktree.png" class="img-fluid" alt="Azfa">
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
                <a class="d-block" href="bidang/software/fathi/fathi.html" target="_blank">
                  <img width="1920" height="1280" src="assets/images/fathi.png" class="img-fluid" alt="Fathi">
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
                <a class="d-block" href="bidang/software/najwa/projek.html" target="_blank">
                  <img width="1920" height="1280" src="assets/images/najwa.png" class="img-fluid" alt="Najwa">
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
                <a class="d-block" href="bidang/software/fatih/index.html" target="_blank">
                  <img width="1920" height="1280" src="assets/images/fatih.png" class="img-fluid" alt="Fatih">
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
                <a class="d-block" href="bidang/software/putri/Index.html" target="_blank">
                  <img width="1920" height="1280" src="assets/images/putri.png" class="img-fluid" alt="Putri">
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
                <a class="d-block" href="bidang/software/hukma/index.html" target="_blank">
                  <img width="1920" height="1280" src="assets/images/allysha.png" class="img-fluid" alt="Allysha">
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
                <a class="d-block" href="bidang/software/meta/meta.html" target="_blank">
                  <img width="1920" height="1280" src="assets/images/meta.png" class="img-fluid" alt="Meta">
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
                <a class="d-block" href="bidang/software/dinda/dinda.html" target="_blank">
                  <img width="1920" height="1280" src="assets/images/dinda.png" class="img-fluid" alt="Dinda">
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
                <a class="d-block" href="bidang/software/dzikra/index.html" target="_blank">
                  <img width="1920" height="1280" src="assets/images/dzikra.png" class="img-fluid" alt="Dzikra">
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
                <a class="d-block" href="bidang/software/ratih/index.html" target="_blank">
                  <img width="1920" height="1280" src="assets/images/ratih.png" class="img-fluid" alt="Ratih">
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
                <a class="d-block" href="bidang/software/fajri/linktree.html" target="_blank">
                  <img width="1920" height="1280" src="assets/images/fajri.png" class="img-fluid" alt="Fajri">
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
                <a class="d-block" href="bidang/software/intan/index.html" target="_blank">
                  <img width="1920" height="1280" src="assets/images/intan.png" class="img-fluid" alt="Intan">
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
                <a class="d-block" href="bidang/software/reva/index.html" target="_blank">
                  <img width="1920" height="1280" src="assets/images/reva.png" class="img-fluid" alt="Reva">
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
                <a class="d-block" href="bidang/software/sekar/100.html" target="_blank">
                  <img width="1920" height="1280" src="assets/images/sekar.png" class="img-fluid" alt="Sekar">
                </a>
            </div>
            </div>
            <br>
